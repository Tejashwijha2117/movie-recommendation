...
# CONFIG
# =============================
API_BASE = "https://movie-recommendation-bbpn.onrender.com" or "http://127.0.0.1:8000"
...
if st.session_state.view == "home":
    ...
    # SEARCH MODE
    # (Autocomplete + word-match results)
    if typed.strip():
...
# ==========================================================
    ...
    # Recommendations
    # (TF-IDF + Genre) via your bundle endpoint
    title = (
        data.get("title") or ""
    ).strip()
